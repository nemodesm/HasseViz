...
namespace FasterThanGrapple.Graphics;
...
public class MTexture
{
    static public MTexture FromFile(string filename)
    {
        ...
        var texture = Texture2D.FromStream(HasseVizGui.Mapper.Instance.GraphicsDevice, fileStream);
        fileStream.Close();
    ...
    public MTexture(int width, int height, Color color) : this(width, height, color, HasseVizGui.Mapper.Instance.GraphicsDevice) { }

    public MTexture(int width, int height, Color color, GraphicsDevice graphicsDevice)
    {
    ...
    public Rectangle GetRelativeRect(int x, int y, int width, int height)
    {
        ...
        var rX = (int)MathHelper.Clamp(atX, ClipRect.Left, ClipRect.Right);
        var rY = (int)MathHelper.Clamp(atY, ClipRect.Top, ClipRect.Bottom);
        var rW = Math.Max(0, Math.Min(atX + width, ClipRect.Right) - rX);
        var rH = Math.Max(0, Math.Min(atY + height, ClipRect.Bottom) - rY);
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, -DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, flip, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, GetRelativeRect(clip), color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, Center - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, Center - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, Center - DrawOffset, scale, flip, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
    }
...
#endif
        HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, flip, 0);
    }
    ...
    public void DrawOutline(Vector2 position)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0,
    ...
    public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale, float rotation)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation,
                        origin - DrawOffset, scale, SpriteEffects.None, 0);
                }
            }
        }
    ...
    public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale, float rotation, SpriteEffects flip)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, origin - DrawOffset, scale, flip, 0);
                }
            }
        }
    ...
    public void DrawOutline(Vector2 position, Vector2 origin, Color color, Vector2 scale)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
                }
            }
        }
    ...
    public void DrawOutline(Vector2 position, Vector2 origin, Color color, Vector2 scale, float rotation)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
                }
            }
        }
    ...
    public void DrawOutlineCentered(Vector2 position)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
                }
            }
        }
    ...
    public void DrawOutlineCentered(Vector2 position, Color color, float scale)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, Center - DrawOffset, scale, SpriteEffects.None, 0);
                }
            }
        }
    ...
    public void DrawOutlineCentered(Vector2 position, Color color, float scale, float rotation)
    {
        ...
        for (var i = -1; i <= 1; i++)
        {
            for (var j = -1; j <= 1; j++)
            {
                if (i != 0 || j != 0)
                {
                    HasseVizGui.Util.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, Center - DrawOffset, scale, SpriteEffects.None, 0);
                }
            }
        }
